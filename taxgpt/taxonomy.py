...
CATEGORIES: tuple[Category, ...] = (
    ...
    Category(
        ...
        "Werbungskosten",
        "Kosten für beruflich veranlasste doppelte Haushaltsführung.",
        "Hattest du aus beruflichen Gründen einen zweiten Haushalt?",
    ),
    Category(
        "family_home_trips",
        "work_expense",
        "Familienheimfahrten",
        "Werbungskosten",
        "Kosten für beruflich veranlasste Familienheimfahrten.",
        "Hattest du aus beruflichen Gründen Familienheimfahrten?",
    ),
    Category(
        "commuter_allowance",
        "work_expense",
    ...
    Category(
        ...
        "Pendlereuro",
        "Pendlerpauschale/-euro",
        "Pendlereuro laut Pendlerrechner, wenn nicht bereits richtig berücksichtigt.",
        "Musst du den Pendlereuro gesondert beantragen oder korrigieren?",
    ),
    Category(
        "social_insurance",
        "work_expense",
        "Pflichtbeiträge / selbst einbezahlte Sozialversicherung",
        "Werbungskosten",
        ...
        "Hast du Pflichtbeiträge oder selbst einbezahlte Sozialversicherungsbeiträge geleistet?",
    ),
    Category(
        "other_work_expense",
        "work_expense",
